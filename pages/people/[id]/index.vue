...
const { data, status, error, refresh, clear } = await useAsyncData<TimelineData>(timelineKey, () => $fetch<TimelineData>(apiBase + 'people/' + route.params.id + '/timeline/', apiFetchOptions()))
