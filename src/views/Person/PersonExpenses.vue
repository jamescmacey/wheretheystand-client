...
export default {
  ...
  created () {
    this.$store.dispatch('fetchPersonMpExpenses', { identifier: this.$route.params.id })
    this.$store.dispatch('fetchPersonExecExpenses', { identifier: this.$route.params.id })
    this.$store.dispatch('fetchPersonReturns', { identifier: this.$route.params.id })
  },
  methods: {
  ...
  computed: {
    ...
    execExpenses () {
      return this.$store.getters.personExecExpensesByIdentifier(this.$route.params.id)
    },
    mpExpenses () {
      return this.$store.getters.personMpExpensesByIdentifier(this.$route.params.id)
    },
    returns () {
      return this.$store.getters.personReturnsByIdentifier(this.$route.params.id)
    },
    returnsRows () {
      var rows = []
