...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div class="container"><div class="row mt-3"><div class="col-12"><h4>Amendments</h4>`);
  _push(ssrRenderComponent(_component_Card, null, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<h5${_scopeId}>February 2024</h5><p${_scopeId}>Deleted &quot;Most information is held by Microsoft in Australia&quot; and substituted &quot;Most information is held by DigitalOcean in Australia, but DigitalOcean does not have access to that information&quot;. This change reflects the position as at 27 January 2024 following a platform migration.</p>`);
      } else {
        return [
          createVNode("h5", null, "February 2024"),
          createVNode("p", null, 'Deleted "Most information is held by Microsoft in Australia" and substituted "Most information is held by DigitalOcean in Australia, but DigitalOcean does not have access to that information". This change reflects the position as at 27 January 2024 following a platform migration.')
        ];
      }
    }),
    _: 1
  }, _parent));
  _push(`<h4>Copyright</h4>`);
  _push(ssrRenderComponent(_component_Card, null, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        return [
          ...
          createVNode("p", null, "Hosting providers for WhereTheyStand hold your information on behalf of WhereTheyStand. Most information is held by DigitalOcean in Australia, but DigitalOcean does not have access to that information"),
          ...
          createVNode("h5", null, "Privacy for parties"),
          createVNode("p", null, "WhereTheyStand operates a party communication archive, called Venus, which stores all subscriber emails your party sends to it. In the future this archive will be public."),
          createVNode("p", null, "In the event that an email containing personal information is inadvertently sent, that email may show on WhereTheyStand\u2014if this is the case, please get in touch and this will be manually edited out."),
          createVNode("p", null, "No edits will be made where they do not relate to privacy, safety, or compliance with the law.")
        ];
      }
    }),
    _: 1
...
//# sourceMappingURL=terms-c41fa0d7.mjs.map
