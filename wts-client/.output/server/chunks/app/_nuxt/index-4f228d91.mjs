import { f as defineStore, u as useFetch, A as API_BASE, _ as _export_sfc, H as Head, M as Meta, a as __nuxt_component_2, e as __nuxt_component_1, b as __nuxt_component_6$1, d as __nuxt_component_0$1 } from '../server.mjs';
...
import { format, parse, parseISO, formatDistanceToNow } from 'date-fns';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  if ($options.bill) {
    _push(`<div${ssrRenderAttrs(mergeProps({ id: "bill-view" }, _attrs))} data-v-92a9dc2c>`);
    ...
    _push(`<div class="container mt-3" data-v-92a9dc2c><div class="row" data-v-92a9dc2c><div class="col-12 col-lg-8" data-v-92a9dc2c><h4 data-v-92a9dc2c>About this bill</h4>`);
    _push(ssrRenderComponent(_component_Card, null, {
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`${ssrInterpolate($options.bill.description)} `);
          if ($options.bill.voting_method != "unk") {
            _push2(`<h5 class="mt-3" data-v-92a9dc2c${_scopeId}>Voting method</h5>`);
          } else {
            _push2(`<!---->`);
          }
          if ($options.bill.voting_method == "per") {
            _push2(`<span data-v-92a9dc2c${_scopeId}>`);
            _push2(ssrRenderComponent(_component_FontAwesomeIcon, { icon: ["fas", "person"] }, null, _parent2, _scopeId));
            _push2(` <strong data-v-92a9dc2c${_scopeId}>Personal voting: </strong> MPs voted individually on this bill. </span>`);
          } else {
            _push2(`<!---->`);
          }
          if ($options.bill.voting_method == "par") {
            ...
            _push2(` <strong data-v-92a9dc2c${_scopeId}>Party voting: </strong> Parties decided whether or not to support this bill and cast votes on behalf of all their MPs. </span>`);
          } else {
            _push2(`<!---->`);
          }
          if ($options.bill.voting_method == "mix") {
            ...
            _push2(` / `);
            _push2(ssrRenderComponent(_component_FontAwesomeIcon, { icon: ["fas", "person"] }, null, _parent2, _scopeId));
            _push2(` <strong data-v-92a9dc2c${_scopeId}>Mixed voting: </strong> Both personal and party voting were used at different stages of this bill&#39;s progression. </span>`);
          } else {
            _push2(`<!---->`);
          }
          if ($options.bill.urgency_used || $options.bill.extended_sittings_used) {
            _push2(`<h5 class="mt-3" data-v-92a9dc2c${_scopeId}>Procedural notes</h5>`);
          } else {
            _push2(`<!---->`);
          }
          _push2(`<ul class="procedural-list pb-0 ps-0" data-v-92a9dc2c${_scopeId}>`);
          if ($options.bill.urgency_used) {
            _push2(`<li class="procedural-list" data-v-92a9dc2c${_scopeId}>`);
            _push2(ssrRenderComponent(_component_FontAwesomeIcon, {
              class: "me-2",
              icon: ["fas", "forward-fast"]
            }, null, _parent2, _scopeId));
            _push2(`<strong data-v-92a9dc2c${_scopeId}>Urgency used: </strong> This bill was progressed through one or more stages using urgency. Urgency allows the Government to fast-track the legislative process by extending the sitting hours of the House of Representatives and skipping the select committee stage of a bill, and allows bills to pass through more than one stage per sitting day. <br data-v-92a9dc2c${_scopeId}><small data-v-92a9dc2c${_scopeId}>`);
          ...
          if ($options.bill.extended_sittings_used) {
            ...
            _push2(`<strong data-v-92a9dc2c${_scopeId}>Extended sittings used: </strong> This bill was progressed during one or more extended sittings of the House of Representatives. This enables MPs to meet for longer than normal to consider legislation. It does not alter the stages that a bill must pass through to become law. <br data-v-92a9dc2c${_scopeId}><small data-v-92a9dc2c${_scopeId}>`);
          ...
          if ($options.bill.pco_url || $options.actUrl) {
            _push2(`<h5 class="mt-3" data-v-92a9dc2c${_scopeId}>Read the bill</h5>`);
          } else {
            _push2(`<!---->`);
          }
          ...
          if ($options.bill.pco_url && $options.actUrl) {
            _push2(`<br data-v-92a9dc2c${_scopeId}>`);
          } else {
            _push2(`<!---->`);
          }
          if ($options.actUrl) {
          ...
          _push2(`<hr data-v-92a9dc2c${_scopeId}><div class="row" data-v-92a9dc2c${_scopeId}>`);
          if (!$options.bill.parliament_api_id) {
            _push2(`<div class="col-12 col-xl-6" data-v-92a9dc2c${_scopeId}>`);
            _push2(ssrRenderComponent(_component_ExternalLinkInline, {
          ...
          _push2(`<div class="col-12 col-xl-6 text-xl-end" data-v-92a9dc2c${_scopeId}>`);
    ...
    if ($options.bill.people_responsible.length > 0) {
      _push(`<h4 data-v-92a9dc2c>Member`);
      if ($options.bill.people_responsible.length > 1) {
        _push(`<span data-v-92a9dc2c>s</span>`);
      } else {
        _push(`<!---->`);
      }
    ...
    _push(`<div class="row" data-v-92a9dc2c><!--[-->`);
    ssrRenderList($options.bill.people_responsible, (person) => {
      _push(`<div class="col-12 col-lg-6" data-v-92a9dc2c>`);
      _push(ssrRenderComponent(_component_PersonCard, { person }, null, _parent));
      _push(`</div>`);
    });
    _push(`<!--]--></div></div><div class="col-12 col-lg-4" data-v-92a9dc2c><h4 data-v-92a9dc2c>Progress</h4>`);
    _push(ssrRenderComponent(_component_Card, { gradient: true }, {
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`<h3 data-v-92a9dc2c${_scopeId}>${ssrInterpolate($options.bill.progress_desc)}</h3><p data-v-92a9dc2c${_scopeId}>${ssrInterpolate($options.progressExplanation)}</p>`);
        } else {
          return [
    ...
    _push(`</div></div><h3 data-v-92a9dc2c>Votes</h3><div class="row" data-v-92a9dc2c><div class="col-12 col-lg-4" data-v-92a9dc2c>`);
    if ($options.firstReading) {
      ...
      _push(ssrRenderComponent(_component_Card, { missing: true }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h6 class="text-uppercase text-muted" data-v-92a9dc2c${_scopeId}><strong data-v-92a9dc2c${_scopeId}>1st reading</strong></h6><h6 class="text-muted" data-v-92a9dc2c${_scopeId}>This vote has not yet occurred, or is not yet recorded on WhereTheyStand.</h6>`);
          } else {
            return [
    ...
    _push(`</div><div class="col-12 col-lg-4" data-v-92a9dc2c>`);
    if ($options.secondReading) {
      ...
      _push(ssrRenderComponent(_component_Card, { missing: true }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h6 class="text-uppercase text-muted" data-v-92a9dc2c${_scopeId}><strong data-v-92a9dc2c${_scopeId}>2nd reading</strong></h6><h6 class="text-muted" data-v-92a9dc2c${_scopeId}>This vote has not yet occurred, or is not yet recorded on WhereTheyStand.</h6>`);
          } else {
            return [
              createVNode("h6", { class: "text-uppercase text-muted" }, [
    ...
    if ($options.thirdReading) {
      ...
      _push(ssrRenderComponent(_component_Card, { missing: true }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h6 class="text-uppercase text-muted" data-v-92a9dc2c${_scopeId}><strong data-v-92a9dc2c${_scopeId}>3rd reading</strong></h6><h6 class="text-muted" data-v-92a9dc2c${_scopeId}>This vote has not yet occurred, or is not yet recorded on WhereTheyStand.</h6>`);
          } else {
            return [
              createVNode("h6", { class: "text-uppercase text-muted" }, [
    ...
    _push(`</div></div><p class="text-muted" data-v-92a9dc2c>Only reading votes are shown here; these votes determine whether the Bill progresses through Parliament. Other votes, such as votes on whether to amend parts of the Bill, can be seen in Hansard.</p><p class="text-muted" data-v-92a9dc2c>Bill details last synced with the Parliament website ${ssrInterpolate($options.relativeDate)}. <br data-v-92a9dc2c><small data-v-92a9dc2c>(${ssrInterpolate($options.formatDateTime($options.bill.last_retrieved))})</small></p></div></div>`);
  } else {
    _push(`<!---->`);
  }
}
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-92a9dc2c"]]);

export { index as default };
//# sourceMappingURL=index-4f228d91.mjs.map
