...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(_attrs)} data-v-f455b67d><h4 data-v-f455b67d>Filter bills</h4>`);
  ...
  _push(ssrRenderComponent(_component_Card, null, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<form data-v-f455b67d${_scopeId}><div class="row mb-2" data-v-f455b67d${_scopeId}><div class="col-12" data-v-f455b67d${_scopeId}><h5 data-v-f455b67d${_scopeId}>Refine by title</h5><label for="text_filter" data-v-f455b67d${_scopeId}>Title must contain the following:</label><input${ssrRenderAttr("value", $data.filterSettings.titleContains)} class="form-control" type="input" id="text_filter" data-v-f455b67d${_scopeId}><small class="text-muted" data-v-f455b67d${_scopeId}>For less strict textual search, you may wish to use the site-wide search function.</small></div></div><hr data-v-f455b67d${_scopeId}><div class="row" data-v-f455b67d${_scopeId}><div class="col-12 col-xl-3" data-v-f455b67d${_scopeId}><h5 data-v-f455b67d${_scopeId}>Bill types</h5><div class="form-check" data-v-f455b67d${_scopeId}><input${ssrIncludeBooleanAttr(Array.isArray($data.filterSettings.billTypes.gov) ? ssrLooseContain($data.filterSettings.billTypes.gov, "") : $data.filterSettings.billTypes.gov) ? " checked" : ""} class="form-check-input" type="checkbox" value="" id="check_goverment" data-v-f455b67d${_scopeId}><label class="form-check-label" for="check_goverment" data-v-f455b67d${_scopeId}> Government bills </label></div><div class="form-check" data-v-f455b67d${_scopeId}><input${ssrIncludeBooleanAttr(Array.isArray($data.filterSettings.billTypes.mem) ? ssrLooseContain($data.filterSettings.billTypes.mem, "") : $data.filterSettings.billTypes.mem) ? " checked" : ""} class="form-check-input" type="checkbox" value="" id="check_members" data-v-f455b67d${_scopeId}><label class="form-check-label" for="check_members" data-v-f455b67d${_scopeId}> Members&#39; bills </label></div><div class="form-check" data-v-f455b67d${_scopeId}><input${ssrIncludeBooleanAttr(Array.isArray($data.filterSettings.billTypes.loc) ? ssrLooseContain($data.filterSettings.billTypes.loc, "") : $data.filterSettings.billTypes.loc) ? " checked" : ""} class="form-check-input" type="checkbox" value="" id="check_local" data-v-f455b67d${_scopeId}><label class="form-check-label" for="check_local" data-v-f455b67d${_scopeId}> Local bills </label></div><div class="form-check" data-v-f455b67d${_scopeId}><input${ssrIncludeBooleanAttr(Array.isArray($data.filterSettings.billTypes.pri) ? ssrLooseContain($data.filterSettings.billTypes.pri, "") : $data.filterSettings.billTypes.pri) ? " checked" : ""} class="form-check-input" type="checkbox" value="" id="check_private" data-v-f455b67d${_scopeId}><label class="form-check-label" for="check_private" data-v-f455b67d${_scopeId}> Private bills </label></div><small data-v-f455b67d${_scopeId}><strong data-v-f455b67d${_scopeId}>OR</strong>: Bills must be any of the selected type to be shown.</small></div><div class="col-12 col-xl-3" data-v-f455b67d${_scopeId}><h5 data-v-f455b67d${_scopeId}>Temporal characteristics</h5><label for="parliament_select" data-v-f455b67d${_scopeId}>Parliamentary term of introduction</label><select class="form-select" id="parliament_select" aria-label="-" data-v-f455b67d${_scopeId}><option value="" selected data-v-f455b67d${_scopeId}>Any</option><option value="53" data-v-f455b67d${_scopeId}>53rd Parliament</option><option value="52" data-v-f455b67d${_scopeId}>52nd Parliament</option><option value="51" data-v-f455b67d${_scopeId}>51st Parliament</option><option value="50" data-v-f455b67d${_scopeId}>50th Parliament</option></select></div><div class="col-12 col-xl-3" data-v-f455b67d${_scopeId}><h5 data-v-f455b67d${_scopeId}>Procedural characteristics</h5><div class="form-check" data-v-f455b67d${_scopeId}><input${ssrIncludeBooleanAttr(Array.isArray($data.filterSettings.characteristics.urgencyUsed) ? ssrLooseContain($data.filterSettings.characteristics.urgencyUsed, "") : $data.filterSettings.characteristics.urgencyUsed) ? " checked" : ""} class="form-check-input" type="checkbox" value="" id="check_urgency" data-v-f455b67d${_scopeId}><label class="form-check-label" for="check_urgency" data-v-f455b67d${_scopeId}> Urgency used </label></div><div class="form-check" data-v-f455b67d${_scopeId}><input${ssrIncludeBooleanAttr(Array.isArray($data.filterSettings.characteristics.extendedSittingsUsed) ? ssrLooseContain($data.filterSettings.characteristics.extendedSittingsUsed, "") : $data.filterSettings.characteristics.extendedSittingsUsed) ? " checked" : ""} class="form-check-input" type="checkbox" value="" id="check_extended" data-v-f455b67d${_scopeId}><label class="form-check-label" for="check_extended" data-v-f455b67d${_scopeId}> Extended sittings used </label></div><div class="form-check" data-v-f455b67d${_scopeId}><input${ssrIncludeBooleanAttr(Array.isArray($data.filterSettings.characteristics.submissionsOpen) ? ssrLooseContain($data.filterSettings.characteristics.submissionsOpen, "") : $data.filterSettings.characteristics.submissionsOpen) ? " checked" : ""} class="form-check-input" type="checkbox" value="" id="check_submissions_open" data-v-f455b67d${_scopeId}><label class="form-check-label" for="check_submissions_open" data-v-f455b67d${_scopeId}> Open for submissions </label></div><label for="voting_method_select" class="mt-2" data-v-f455b67d${_scopeId}>Voting method</label><select class="form-select" id="voting_method_select" aria-label="Voting method" data-v-f455b67d${_scopeId}><option value="" selected data-v-f455b67d${_scopeId}>Any</option><option value="per" data-v-f455b67d${_scopeId}>Personal voting used</option><option value="par" data-v-f455b67d${_scopeId}>Party voting used</option></select><small data-v-f455b67d${_scopeId}><strong data-v-f455b67d${_scopeId}>AND</strong>: Bills must meet all of these criteria to be shown.</small></div></div><hr data-v-f455b67d${_scopeId}><h5 data-v-f455b67d${_scopeId}>Display options</h5><div class="row" data-v-f455b67d${_scopeId}><div class="col-12 col-xl-3" data-v-f455b67d${_scopeId}><label for="per_page_select" data-v-f455b67d${_scopeId}>Results per page</label><select class="form-select" id="per_page_select" aria-label="Results per page" data-v-f455b67d${_scopeId}><option value="10" selected data-v-f455b67d${_scopeId}>10</option><option value="25" data-v-f455b67d${_scopeId}>25</option><option value="50" data-v-f455b67d${_scopeId}>50</option><option value="100" data-v-f455b67d${_scopeId}>100</option></select><div class="form-check" data-v-f455b67d${_scopeId}><input${ssrIncludeBooleanAttr(Array.isArray($data.showDescriptions) ? ssrLooseContain($data.showDescriptions, "") : $data.showDescriptions) ? " checked" : ""} class="form-check-input" type="checkbox" value="" id="check_show_descriptions" data-v-f455b67d${_scopeId}><label class="form-check-label" for="check_show_descriptions" data-v-f455b67d${_scopeId}> Show bill descriptions </label></div></div><div class="col-12 col-xl-3" data-v-f455b67d${_scopeId}><label for="order_by_select" data-v-f455b67d${_scopeId}>Order by</label><select class="form-select" id="order_by_select" aria-label="Order by" data-v-f455b67d${_scopeId}><option value="date_modified_desc" selected data-v-f455b67d${_scopeId}>Date modified (newest first)</option><option value="date_modified_asc" data-v-f455b67d${_scopeId}>Date modified (oldest first)</option><option value="introduction_date_desc" data-v-f455b67d${_scopeId}>Introduction date (newest first)</option><option value="introduction_date_asc" data-v-f455b67d${_scopeId}>Introduction date (oldest first)</option><option value="progress_desc" data-v-f455b67d${_scopeId}>Status (later stages first)</option><option value="progress_asc" data-v-f455b67d${_scopeId}>Status (early stages first)</option></select></div></div><hr data-v-f455b67d${_scopeId}><div class="row" data-v-f455b67d${_scopeId}><div class="col-12" data-v-f455b67d${_scopeId}>`);
        if ($options.activeString != $options.userString && !$data.isLoading) {
          _push2(`<button class="btn btn-primary" type="button" id="button-addon2" data-v-f455b67d${_scopeId}>Refine selection</button>`);
        } else {
          _push2(`<button disabled class="btn btn-primary" type="button" id="button-addon2" data-v-f455b67d${_scopeId}>Refine selection</button>`);
        }
        if ($data.isLoading) {
  ...
  _push(`<span id="results-marker" data-v-f455b67d></span>`);
  if ($data.page) {
    _push(`<div data-v-f455b67d><h4 data-v-f455b67d>Results</h4> ${ssrInterpolate($options.displayCount)} result`);
    if ($options.displayCount != 1) {
      _push(`<span data-v-f455b67d>s</span>`);
    } else {
      _push(`<!---->`);
    }
    _push(`. <!--[-->`);
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_Card, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<h6 class="mb-0" data-v-f455b67d${_scopeId2}>${ssrInterpolate(bill.name)}</h6><small class="me-1" data-v-f455b67d${_scopeId2}>`);
                  if (bill.progress == "inp") {
                    _push3(`<span class="badge bg-primary text-uppercase" data-v-f455b67d${_scopeId2}>${ssrInterpolate(bill.progress_desc)}</span>`);
                  } else if (bill.progress == "pas") {
                    _push3(`<span class="badge bg-success text-uppercase" data-v-f455b67d${_scopeId2}>${ssrInterpolate(bill.progress_desc)}</span>`);
                  } else if (bill.progress == "ena") {
                    _push3(`<span class="badge bg-success text-uppercase" data-v-f455b67d${_scopeId2}>${ssrInterpolate(bill.progress_desc)}</span>`);
                  } else if (bill.progress == "dis") {
                    _push3(`<span class="badge bg-warning text-dark text-uppercase" data-v-f455b67d${_scopeId2}>${ssrInterpolate(bill.progress_desc)}</span>`);
                  } else if (bill.progress == "def") {
                    _push3(`<span class="badge bg-danger text-uppercase" data-v-f455b67d${_scopeId2}>${ssrInterpolate(bill.progress_desc)}</span>`);
                  } else if (bill.progress == "lap") {
                    _push3(`<span class="badge bg-danger text-uppercase" data-v-f455b67d${_scopeId2}>${ssrInterpolate(bill.progress_desc)}</span>`);
                  } else if (bill.progress == "unx") {
                    _push3(`<span class="badge bg-danger text-uppercase" data-v-f455b67d${_scopeId2}>${ssrInterpolate(bill.progress_desc)}</span>`);
                  } else if (bill.progress == "div") {
                    _push3(`<span class="badge bg-info text-uppercase" data-v-f455b67d${_scopeId2}>${ssrInterpolate(bill.progress_desc)}</span>`);
                  } else if (bill.progress == "wit") {
                    _push3(`<span class="badge bg-warning text-dark text-uppercase" data-v-f455b67d${_scopeId2}>${ssrInterpolate(bill.progress_desc)}</span>`);
                  } else {
                    _push3(`<span class="badge bg-secondary text-uppercase" data-v-f455b67d${_scopeId2}>${ssrInterpolate(bill.progress_desc)}</span>`);
                  }
                  _push3(`</small><small class="text-muted text-uppercase" data-v-f455b67d${_scopeId2}>${ssrInterpolate(bill.type_desc)}</small>`);
                  if (bill.description && $data.showDescriptions) {
                    _push3(`<p data-v-f455b67d${_scopeId2}>${ssrInterpolate(bill.description)}</p>`);
                  } else if ($data.showDescriptions) {
                    _push3(`<p class="text-muted" data-v-f455b67d${_scopeId2}> No description. </p>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  if (!$data.showDescriptions) {
                    _push3(`<br data-v-f455b67d${_scopeId2}>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  _push3(`<small data-v-f455b67d${_scopeId2}>`);
                  if (bill.date_modified) {
                    _push3(`<span${ssrRenderAttr("title", $options.formattedDate(bill.date_modified))} class="text-muted" data-v-f455b67d${_scopeId2}>`);
    ...
    if (!$data.isLoading && !$data.hasLoadedData && $setup.prefetchData && $options.displayCount > 1) {
      _push(`<nav aria-label="bills_pagination" data-v-f455b67d><ul class="pagination mb-1" data-v-f455b67d><li class="${ssrRenderClass([{ disabled: !$options.displayPrevious }, "page-item"])}" data-v-f455b67d><a class="page-link" href="#results-marker" data-v-f455b67d>Previous</a></li>`);
      if ($options.displayPrevious) {
        _push(`<li class="page-item" data-v-f455b67d><a class="page-link" href="#results-marker" data-v-f455b67d>${ssrInterpolate($options.displayPage - 1)}</a></li>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<li class="page-item active" aria-current="page" data-v-f455b67d><a class="page-link" href="#results-marker" data-v-f455b67d>${ssrInterpolate($options.displayPage)}</a></li>`);
      if ($options.displayNext) {
        _push(`<li class="page-item" data-v-f455b67d><a class="page-link" href="#results-marker" data-v-f455b67d>${ssrInterpolate($options.displayPage + 1)}</a></li>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<li class="${ssrRenderClass([{ disabled: !$options.displayNext }, "page-item"])}" data-v-f455b67d><a class="page-link" href="#results-marker" data-v-f455b67d>Next</a></li></ul>`);
      if ($options.displayPage != 1) {
        _push(`<a id="back-to-start" href="#results-marker" data-v-f455b67d><small data-v-f455b67d>Back to start</small></a>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</nav>`);
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-f455b67d"]]);
const _sfc_main = {};
...
//# sourceMappingURL=index-ade4de15.mjs.map
