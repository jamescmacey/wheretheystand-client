...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "container" }, _attrs))}><div class="row mt-3"><div class="col-12"><h4>Expenses and donations</h4><p><strong>Note:</strong> These expenses aren&#39;t currently being updated because work to display them in a better way is underway. <span class="text-muted">\u2014 7 March 2024.</span></p></div></div><div class="row"><div class="col-12">`);
...
//# sourceMappingURL=expenses-a1968bf4.mjs.map
