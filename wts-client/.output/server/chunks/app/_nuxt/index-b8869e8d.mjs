import { _ as _export_sfc, H as Head, M as Meta, a as __nuxt_component_2, d as __nuxt_component_0$1 } from '../server.mjs';
...
import { u as useElectoratesStore } from './electorates-5ab9b137.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  if ($options.electorate) {
    _push(`<div${ssrRenderAttrs(mergeProps({ id: "electorate-view" }, _attrs))} data-v-06d05b5d>`);
    ...
    _push(`<div class="container-fluid hero pt-0" data-v-06d05b5d></div><div class="mt-3 container" data-v-06d05b5d>`);
    if (($options.electorate.status === "current" || $options.electorate.status === "retiring") && $options.electorate.incumbent) {
      _push(`<div data-v-06d05b5d><div class="row" data-v-06d05b5d><div class="col-12 col-xl-4" data-v-06d05b5d><h4 data-v-06d05b5d>Incumbent Member of Parliament</h4>`);
    ...
    if ($options.electorate.status !== "current") {
      _push(`<div data-v-06d05b5d><div class="row" data-v-06d05b5d><div class="col-12" data-v-06d05b5d>`);
      if ($options.electorate.status === "retiring") {
        _push(ssrRenderComponent(_component_Card, null, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<h5 data-v-06d05b5d${_scopeId}>This electorate is retiring`);
              if ($options.electorate.valid_to) {
                _push2(`<span data-v-06d05b5d${_scopeId}> on ${ssrInterpolate($options.formatDate($options.electorate.valid_to))}</span>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`.</h5>`);
              if ($options.electorate.replaced_by) {
                _push2(`<p data-v-06d05b5d${_scopeId}>The electorate of ${ssrInterpolate($options.electorate.name)} will be replaced by `);
      ...
      if ($options.electorate.status === "former") {
        _push(ssrRenderComponent(_component_Card, null, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<h5 data-v-06d05b5d${_scopeId}>This electorate retired`);
              if ($options.electorate.valid_to) {
                _push2(`<span data-v-06d05b5d${_scopeId}> on ${ssrInterpolate($options.formatDate($options.electorate.valid_to))}</span>`);
              } else {
                _push2(`<!---->`);
              ...
              _push2(`.</h5>`);
              if ($options.electorate.replaced_by) {
                _push2(`<p data-v-06d05b5d${_scopeId}>The electorate of ${ssrInterpolate($options.electorate.name)} has been replaced by `);
                _push2(ssrRenderComponent(_component_NuxtLink, {
                  to: "/electorates/" + $options.electorate.replaced_by.slug
                }, {
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
    ...
    _push(`<div class="row" data-v-06d05b5d><div class="col-12" data-v-06d05b5d><h4 data-v-06d05b5d>Previous MPs</h4><div class="form-check" data-v-06d05b5d><input class="form-check-input" type="checkbox" value=""${ssrIncludeBooleanAttr(Array.isArray($data.showReasons) ? ssrLooseContain($data.showReasons, "") : $data.showReasons) ? " checked" : ""} id="showReasons" data-v-06d05b5d><label class="form-check-label" for="showReasons" data-v-06d05b5d> Show reasons for commencement and conclusion of terms </label></div></div><div class="col-12" data-v-06d05b5d>`);
    _push(ssrRenderComponent(_component_Card, null, {
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`<!--[-->`);
          ssrRenderList($options.affiliations, (affiliation, i) => {
            _push2(`<div data-v-06d05b5d${_scopeId}>`);
            _push2(ssrRenderComponent(_component_NuxtLink, {
              class: "NuxtLink",
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (i == 0 || $options.affiliations[i].person.id != $options.affiliations[i - 1].person.id) {
                    _push3(`<div data-v-06d05b5d${_scopeId2}>`);
                    if (affiliation.person.image) {
                      _push3(`<div class="d-flex align-items-center" data-v-06d05b5d${_scopeId2}><div class="flex-shrink-0" data-v-06d05b5d${_scopeId2}>`);
                      if (affiliation.person.image) {
                        _push3(`<img${ssrRenderAttr("src", affiliation.person.image)} class="me-3 person-image"${ssrRenderAttr("alt", affiliation.person.display_name)} data-v-06d05b5d${_scopeId2}>`);
                      } else {
                        _push3(`<!---->`);
                      }
                      _push3(`</div><div class="flex-grow-1 ms-3" data-v-06d05b5d${_scopeId2}><h5 data-v-06d05b5d${_scopeId2}><strong data-v-06d05b5d${_scopeId2}>${ssrInterpolate(affiliation.person.display_name)}</strong></h5><p class="text-muted" data-v-06d05b5d${_scopeId2}>`);
                      ...
                      _push3(`<div data-v-06d05b5d${_scopeId2}><h6 data-v-06d05b5d${_scopeId2}><strong data-v-06d05b5d${_scopeId2}>${ssrInterpolate(affiliation.person.display_name)}</strong></h6><p class="text-muted person-description" data-v-06d05b5d${_scopeId2}>`);
                      if (affiliation.person.colour) {
                  ...
                  _push3(`<div class="row" data-v-06d05b5d${_scopeId2}><div class="col-1" data-v-06d05b5d${_scopeId2}></div><div class="col-11" data-v-06d05b5d${_scopeId2}><div class="row" data-v-06d05b5d${_scopeId2}><div class="col-12 col-md-6" data-v-06d05b5d${_scopeId2}><h6 class="affiliation-date-heading" data-v-06d05b5d${_scopeId2}>Started:</h6> ${ssrInterpolate($options.formatDate(affiliation.start_date))} `);
                  if ($data.showReasons && affiliation.start_reason_desc) {
                    _push3(`<h6 class="affiliation-date-heading" data-v-06d05b5d${_scopeId2}>Reason: </h6>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  if ($data.showReasons && affiliation.start_reason_desc) {
                    _push3(`<span data-v-06d05b5d${_scopeId2}>${ssrInterpolate(affiliation.start_reason_desc)}</span>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  _push3(`</div>`);
                  if (affiliation.end_date) {
                    _push3(`<div class="col-12 col-md-6" data-v-06d05b5d${_scopeId2}><h6 class="affiliation-date-heading" data-v-06d05b5d${_scopeId2}>Ended:</h6> ${ssrInterpolate($options.formatDate(affiliation.end_date))} `);
                    ...
                    if ($data.showReasons && affiliation.end_reason_desc) {
                      _push3(`<span data-v-06d05b5d${_scopeId2}>${ssrInterpolate(affiliation.end_reason_desc)}</span>`);
                    } else {
                      _push3(`<!---->`);
                    }
                    _push3(`</div>`);
                  ...
                  if (i < $options.affiliations.length - 1 && $options.affiliations[i].person.id == $options.affiliations[i + 1].person.id) {
                    _push3(`<hr data-v-06d05b5d${_scopeId2}>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  _push3(`</div></div>`);
          ...
          _push2(`<!--]--><hr data-v-06d05b5d${_scopeId}><p class="text-muted" data-v-06d05b5d${_scopeId}>These dates correspond to when an MP was eligible to sit and vote in the House of Representatives, not when they were declared elected. This list only includes MPs with profiles on WhereTheyStand, so it may contain some gaps.</p>`);
        } else {
          return [
    ...
    if ($options.electorate.replaced_electorate) {
      _push(`<div data-v-06d05b5d><div class="row" data-v-06d05b5d><div class="col-12" data-v-06d05b5d><h4 data-v-06d05b5d>History</h4>`);
      _push(ssrRenderComponent(_component_Card, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h5 data-v-06d05b5d${_scopeId}>This electorate replaced the `);
            _push2(ssrRenderComponent(_component_NuxtLink, {
            ...
            ))}.</h5><p data-v-06d05b5d${_scopeId}>See `);
            _push2(ssrRenderComponent(_component_NuxtLink, {
              to: "/electorates/" + $options.electorate.replaced_electorate.slug
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/ministerial-lists/[id]/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-06d05b5d"]]);

export { index as default };
//# sourceMappingURL=index-b8869e8d.mjs.map
