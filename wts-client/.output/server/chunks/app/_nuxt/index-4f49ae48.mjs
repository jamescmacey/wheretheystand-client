...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  if ($options.bills && $options.bills.length === 0) {
    ...
    _push(ssrRenderComponent(_component_FontAwesomeIcon, { icon: ["fas", "info-circle"] }, null, _parent));
    _push(` ${ssrInterpolate($options.person.display_name)} hasn&#39;t sponsored any bills. This doesn&#39;t include any member&#39;s bills that they might have sitting in the &#39;biscuit tin&#39; which haven&#39;t been drawn yet.</p>`);
...
//# sourceMappingURL=index-4f49ae48.mjs.map
