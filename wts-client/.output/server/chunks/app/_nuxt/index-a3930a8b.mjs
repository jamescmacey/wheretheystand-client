...
import { _ as _export_sfc, u as useFetch, A as API_BASE, e as __nuxt_component_1, H as Head, L as Link, a as __nuxt_component_2$1, d as __nuxt_component_0$1 } from '../server.mjs';
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(_attrs)} data-v-e41c506f><h4 data-v-e41c506f>Filter votes</h4>`);
  ...
  _push(`<button data-v-e41c506f>Update</button>`);
  _push(ssrRenderComponent(_component_Card, null, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<form data-v-e41c506f${_scopeId}><div class="row mb-2" data-v-e41c506f${_scopeId}><div class="col-12" data-v-e41c506f${_scopeId}><h5 data-v-e41c506f${_scopeId}>Refine by bill title</h5><label for="text_filter" data-v-e41c506f${_scopeId}>Bill title must contain the following:</label><input${ssrRenderAttr("value", $data.filterSettings.titleContains)} class="form-control" type="input" id="text_filter" data-v-e41c506f${_scopeId}><small class="text-muted" data-v-e41c506f${_scopeId}>For less strict textual search, you may wish to use the site-wide search function.</small></div></div><hr data-v-e41c506f${_scopeId}><div class="row" data-v-e41c506f${_scopeId}><div class="col-12 col-xl-3" data-v-e41c506f${_scopeId}><h5 data-v-e41c506f${_scopeId}>Bill types</h5><div class="form-check" data-v-e41c506f${_scopeId}><input${ssrIncludeBooleanAttr(Array.isArray($data.filterSettings.billTypes.gov) ? ssrLooseContain($data.filterSettings.billTypes.gov, "") : $data.filterSettings.billTypes.gov) ? " checked" : ""} class="form-check-input" type="checkbox" value="" id="check_goverment" data-v-e41c506f${_scopeId}><label class="form-check-label" for="check_goverment" data-v-e41c506f${_scopeId}> Government bills </label></div><div class="form-check" data-v-e41c506f${_scopeId}><input${ssrIncludeBooleanAttr(Array.isArray($data.filterSettings.billTypes.mem) ? ssrLooseContain($data.filterSettings.billTypes.mem, "") : $data.filterSettings.billTypes.mem) ? " checked" : ""} class="form-check-input" type="checkbox" value="" id="check_members" data-v-e41c506f${_scopeId}><label class="form-check-label" for="check_members" data-v-e41c506f${_scopeId}> Members&#39; bills </label></div><div class="form-check" data-v-e41c506f${_scopeId}><input${ssrIncludeBooleanAttr(Array.isArray($data.filterSettings.billTypes.loc) ? ssrLooseContain($data.filterSettings.billTypes.loc, "") : $data.filterSettings.billTypes.loc) ? " checked" : ""} class="form-check-input" type="checkbox" value="" id="check_local" data-v-e41c506f${_scopeId}><label class="form-check-label" for="check_local" data-v-e41c506f${_scopeId}> Local bills </label></div><div class="form-check" data-v-e41c506f${_scopeId}><input${ssrIncludeBooleanAttr(Array.isArray($data.filterSettings.billTypes.pri) ? ssrLooseContain($data.filterSettings.billTypes.pri, "") : $data.filterSettings.billTypes.pri) ? " checked" : ""} class="form-check-input" type="checkbox" value="" id="check_private" data-v-e41c506f${_scopeId}><label class="form-check-label" for="check_private" data-v-e41c506f${_scopeId}> Private bills </label></div><small data-v-e41c506f${_scopeId}><strong data-v-e41c506f${_scopeId}>OR</strong>: Votes must be for a bill of one of the selected types to be shown.</small></div><div class="col-12 col-xl-3" data-v-e41c506f${_scopeId}><h5 data-v-e41c506f${_scopeId}>Vote options</h5><label for="parliament_select" data-v-e41c506f${_scopeId}>Parliamentary term</label><select class="form-select" id="parliament_select" aria-label="-" data-v-e41c506f${_scopeId}><option value="" selected data-v-e41c506f${_scopeId}>Any</option><option value="53" data-v-e41c506f${_scopeId}>53rd Parliament</option><option value="52" data-v-e41c506f${_scopeId}>52nd Parliament</option><option value="51" data-v-e41c506f${_scopeId}>51st Parliament</option><option value="50" data-v-e41c506f${_scopeId}>50th Parliament</option></select><label for="vote_type_select" class="mt-2" data-v-e41c506f${_scopeId}>Vote type</label><select class="form-select" id="vote_type_select" aria-label="Vote type" data-v-e41c506f${_scopeId}><option value="" selected data-v-e41c506f${_scopeId}>Any</option><option value="personal" data-v-e41c506f${_scopeId}>Personal vote</option><option value="party" data-v-e41c506f${_scopeId}>Party vote</option></select><small data-v-e41c506f${_scopeId}><strong data-v-e41c506f${_scopeId}>AND</strong>: Votes must meet both of these criteria to be shown.</small></div><div class="col-12 col-xl-3" data-v-e41c506f${_scopeId}><h5 data-v-e41c506f${_scopeId}>Display options</h5><label for="per_page_select" data-v-e41c506f${_scopeId}>Results per page</label><select class="form-select" id="per_page_select" aria-label="Results per page" data-v-e41c506f${_scopeId}><option value="10" selected data-v-e41c506f${_scopeId}>10</option><option value="25" data-v-e41c506f${_scopeId}>25</option><option value="50" data-v-e41c506f${_scopeId}>50</option><option value="100" data-v-e41c506f${_scopeId}>100</option></select><label for="order_by_select" class="mt-2" data-v-e41c506f${_scopeId}>Order by</label><select class="form-select" id="order_by_select" aria-label="Order by" data-v-e41c506f${_scopeId}><option value="date_desc" selected data-v-e41c506f${_scopeId}>Date (newest first)</option><option value="date_asc" data-v-e41c506f${_scopeId}>Date (oldest first)</option><option value="reading_desc" data-v-e41c506f${_scopeId}>Reading (latest first)</option><option value="reading_asc" data-v-e41c506f${_scopeId}>Reading (earliest first)</option></select></div></div><hr data-v-e41c506f${_scopeId}><div class="row" data-v-e41c506f${_scopeId}><div class="col-12" data-v-e41c506f${_scopeId}>`);
        if ($options.activeString != $options.userString && !$data.isLoading) {
          _push2(`<button class="btn btn-primary" type="button" id="button-addon2" data-v-e41c506f${_scopeId}>Refine selection</button>`);
        } else {
          _push2(`<button disabled class="btn btn-primary" type="button" id="button-addon2" data-v-e41c506f${_scopeId}>Refine selection</button>`);
        }
        if ($data.isLoading) {
  ...
  _push(`<span id="results-marker" data-v-e41c506f></span>`);
  if ($data.page) {
    _push(`<div data-v-e41c506f><h4 data-v-e41c506f>Results</h4> ${ssrInterpolate($options.displayCount)} result`);
    if ($options.displayCount != 1) {
      _push(`<span data-v-e41c506f>s</span>`);
    } else {
      _push(`<!---->`);
    }
    _push(`. <!--[-->`);
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_Card, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="row" data-v-e41c506f${_scopeId2}><div class="col-12 col-xl-5" data-v-e41c506f${_scopeId2}><h6 class="mb-0" data-v-e41c506f${_scopeId2}>${ssrInterpolate(vote.name)}</h6><small class="me-1" data-v-e41c506f${_scopeId2}>`);
                  if (vote.type_desc) {
                    _push3(`<span class="badge bg-primary text-uppercase" data-v-e41c506f${_scopeId2}>${ssrInterpolate(vote.type_desc)}</span>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  _push3(`</small><small class="text-muted text-uppercase" data-v-e41c506f${_scopeId2}>${ssrInterpolate($options.formattedDateFull(vote.date))}</small><hr class="col-12 d-xl-none mt-2" data-v-e41c506f${_scopeId2}></div><div class="col-12 col-xl-7" data-v-e41c506f${_scopeId2}><div class="row" data-v-e41c506f${_scopeId2}><div class="col-3 text-center" data-v-e41c506f${_scopeId2}><h3 data-v-e41c506f${_scopeId2}>${ssrInterpolate(vote.ayes)}</h3><h6 class="text-muted text-uppercase" data-v-e41c506f${_scopeId2}><span class="dot-yes" data-v-e41c506f${_scopeId2}></span> Ayes</h6></div><div class="col-3 text-center" data-v-e41c506f${_scopeId2}><h3 data-v-e41c506f${_scopeId2}>${ssrInterpolate(vote.noes)}</h3><h6 class="text-muted text-uppercase" data-v-e41c506f${_scopeId2}><span class="dot-no" data-v-e41c506f${_scopeId2}></span> Noes</h6></div><div class="col-3 text-center" data-v-e41c506f${_scopeId2}><h3 data-v-e41c506f${_scopeId2}>${ssrInterpolate(vote.abstentions)}</h3><h6 class="text-muted text-uppercase" data-v-e41c506f${_scopeId2}><span class="dot-abstain" data-v-e41c506f${_scopeId2}></span> Abstentions</h6></div><div class="col-3 text-center" data-v-e41c506f${_scopeId2}><h3 data-v-e41c506f${_scopeId2}>${ssrInterpolate(vote.absent)}</h3><h6 class="text-muted text-uppercase" data-v-e41c506f${_scopeId2}><span class="dot-absent" data-v-e41c506f${_scopeId2}></span> Absent</h6></div></div></div></div>`);
                } else {
                  return [
                    createVNode("div", { class: "row" }, [
    ...
    if (!$data.isLoading && !$data.hasLoadedData && $setup.prefetchData && $options.displayCount > 1) {
      _push(`<nav aria-label="votes_pagination" data-v-e41c506f><ul class="pagination mb-1" data-v-e41c506f><li class="${ssrRenderClass([{ disabled: !$options.displayPrevious }, "page-item"])}" data-v-e41c506f><a class="page-link" href="#results-marker" data-v-e41c506f>Previous</a></li>`);
      if ($options.displayPrevious) {
        _push(`<li class="page-item" data-v-e41c506f><a class="page-link" href="#results-marker" data-v-e41c506f>${ssrInterpolate($options.displayPage - 1)}</a></li>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<li class="page-item active" aria-current="page" data-v-e41c506f><a class="page-link" href="#results-marker" data-v-e41c506f>${ssrInterpolate($options.displayPage)}</a></li>`);
      if ($options.displayNext) {
        _push(`<li class="page-item" data-v-e41c506f><a class="page-link" href="#results-marker" data-v-e41c506f>${ssrInterpolate($options.displayPage + 1)}</a></li>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<li class="${ssrRenderClass([{ disabled: !$options.displayNext }, "page-item"])}" data-v-e41c506f><a class="page-link" href="#results-marker" data-v-e41c506f>Next</a></li></ul>`);
      if ($options.displayPage != 1) {
        _push(`<a id="back-to-start" href="#results-marker" data-v-e41c506f><small data-v-e41c506f>Back to start</small></a>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</nav>`);
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-e41c506f"]]);
const _sfc_main = {};
...
//# sourceMappingURL=index-a3930a8b.mjs.map
