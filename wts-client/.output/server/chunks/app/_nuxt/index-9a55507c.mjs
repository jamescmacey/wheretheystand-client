...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-47128641><div id="cover-image" class="container-fluid text-start py-5" data-v-47128641><div class="container" data-v-47128641><div class="row" data-v-47128641><div class="col-12 col-xl-8 py-xl-5 py-2" data-v-47128641><h1 class="display-4" data-v-47128641>Wondering where they stand?</h1><hr data-v-47128641><h3 data-v-47128641> WhereTheyStand aggregates voting data, financial information, biographical information, and more. </h3></div><div id="onboarding" class="col-12 col-xl-4 py-xl-5 py-2" data-v-47128641>`);
      _push(ssrRenderComponent(_component_Card, { frosted: true }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h4 class="mt-2" data-v-47128641${_scopeId}>Find your MP, electorate or party</h4> All MPs who&#39;ve been in Parliament since 2014 have profiles. `);
      ...
      _push(`</div></div></div></div><div class="container mt-3" data-v-47128641><div class="row" data-v-47128641><div class="col-12 col-xl-4" data-v-47128641><h4 data-v-47128641>Recent votes</h4>`);
      _push(ssrRenderComponent(_component_Card, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (unref(homepageData)) {
              _push2(`<div data-v-47128641${_scopeId}><ul class="homepage-resource-list" data-v-47128641${_scopeId}><!--[-->`);
              ssrRenderList(unref(homepageData).votes, (vote, i) => {
                _push2(`<li class="mb-3 vote-list" data-v-47128641${_scopeId}><h6 class="mb-0" data-v-47128641${_scopeId}>${ssrInterpolate(vote.name)}</h6><small class="me-1" data-v-47128641${_scopeId}>`);
                if (vote.type_desc) {
                  _push2(`<span class="badge bg-primary text-uppercase" data-v-47128641${_scopeId}>${ssrInterpolate(vote.type_desc)}</span>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</small><small class="text-muted text-uppercase" data-v-47128641${_scopeId}>${ssrInterpolate(_ctx.formattedDateFull(vote.date))}</small><br data-v-47128641${_scopeId}><div class="text-start" data-v-47128641${_scopeId}>`);
                ...
                _push2(`</div>`);
                if (i < 4) {
                  _push2(`<hr class="mt-1" data-v-47128641${_scopeId}>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</li>`);
      ...
      _push(`</div><div class="col-12 col-xl-4" data-v-47128641><h4 data-v-47128641>Recently updated bills</h4>`);
      _push(ssrRenderComponent(_component_Card, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (unref(homepageData)) {
              ...
              ssrRenderList(unref(homepageData).bills, (bill, i) => {
                _push2(`<li class="mb-3 bill-list" data-v-47128641${_scopeId}><h6 class="mb-0" data-v-47128641${_scopeId}>${ssrInterpolate(bill.name)}</h6><small class="me-1" data-v-47128641${_scopeId}>`);
                if (bill.progress == "inp") {
                  _push2(`<span class="badge bg-primary text-uppercase" data-v-47128641${_scopeId}>${ssrInterpolate(bill.progress_desc)}</span>`);
                } else if (bill.progress == "pas") {
                  _push2(`<span class="badge bg-success text-uppercase" data-v-47128641${_scopeId}>${ssrInterpolate(bill.progress_desc)}</span>`);
                } else if (bill.progress == "ena") {
                  _push2(`<span class="badge bg-success text-uppercase" data-v-47128641${_scopeId}>${ssrInterpolate(bill.progress_desc)}</span>`);
                } else if (bill.progress == "dis") {
                  _push2(`<span class="badge bg-warning text-dark text-uppercase" data-v-47128641${_scopeId}>${ssrInterpolate(bill.progress_desc)}</span>`);
                } else if (bill.progress == "def") {
                  _push2(`<span class="badge bg-danger text-uppercase" data-v-47128641${_scopeId}>${ssrInterpolate(bill.progress_desc)}</span>`);
                } else if (bill.progress == "lap") {
                  _push2(`<span class="badge bg-danger text-uppercase" data-v-47128641${_scopeId}>${ssrInterpolate(bill.progress_desc)}</span>`);
                } else if (bill.progress == "unx") {
                  _push2(`<span class="badge bg-danger text-uppercase" data-v-47128641${_scopeId}>${ssrInterpolate(bill.progress_desc)}</span>`);
                } else if (bill.progress == "div") {
                  _push2(`<span class="badge bg-info text-uppercase" data-v-47128641${_scopeId}>${ssrInterpolate(bill.progress_desc)}</span>`);
                } else if (bill.progress == "wit") {
                  _push2(`<span class="badge bg-warning text-dark text-uppercase" data-v-47128641${_scopeId}>${ssrInterpolate(bill.progress_desc)}</span>`);
                } else {
                  _push2(`<span class="badge bg-secondary text-uppercase" data-v-47128641${_scopeId}>${ssrInterpolate(bill.progress_desc)}</span>`);
                }
                _push2(`</small><small class="text-muted text-uppercase" data-v-47128641${_scopeId}>${ssrInterpolate(bill.type_desc)}</small><div class="text-start" data-v-47128641${_scopeId}>`);
                _push2(ssrRenderComponent(_component_NuxtLink, {
                  to: "/bills/" + bill.id,
      ...
      _push(`</div><div class="col-12 col-xl-4" data-v-47128641><h4 data-v-47128641>Elections</h4>`);
      _push(ssrRenderComponent(_component_Card, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="election" data-v-47128641${_scopeId}><h5 data-v-47128641${_scopeId}>2023 General Election</h5><span data-v-47128641${_scopeId}>14 October 2023</span><br data-v-47128641${_scopeId}>`);
            ...
            _push2(`</div><div class="election" data-v-47128641${_scopeId}><h5 data-v-47128641${_scopeId}>2022 Hamilton West by-election</h5><span data-v-47128641${_scopeId}>10 December 2022</span><br data-v-47128641${_scopeId}>`);
            ...
            _push2(`</div><hr data-v-47128641${_scopeId}><div class="election" data-v-47128641${_scopeId}><h5 data-v-47128641${_scopeId}>2022 Tauranga by-election</h5><span data-v-47128641${_scopeId}>18 June 2022</span><br data-v-47128641${_scopeId}>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-47128641"]]);

export { index as default };
//# sourceMappingURL=index-9a55507c.mjs.map
