...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_Card, _attrs, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<h5${_scopeId}>Twitter account</h5><a${ssrRenderAttr("href", $props.user.profile_url)} target="_blank"${_scopeId}><h6${_scopeId}>`);
        ...
        return [
          createVNode("h5", null, "Twitter account"),
          createVNode("a", {
...
//# sourceMappingURL=details-9222aff6.mjs.map
