...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_ExternalLinkButton, {
    link: "https://www.parliament.nz/en/mps-and-electorates/members-financial-interests/",
    text: "Learn more on the Parliament website"
  }, null, _parent));
  if ($options.interests && Object.keys($options.interests).length !== 0) {
      ...
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          ...
          return [
            ...
            (openBlock(), createBlock(Fragment, null, renderList(14, (i) => {
...
//# sourceMappingURL=interests-c39fde85.mjs.map
